      ...
      <div className="flex justify-center items-center">
        <div className="max-w-md w-full p-8 bg-white bg-opacity-90 shadow-lg rounded-md ">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full bg-indigo-500 text-white font-bold py-2 px-4 rounded-md focus:outline-none focus:bg-indigo-600 bg-gradient-to-r from-blue-500 to-pink-500"
            >
              LogIn
            </button>
          </form>

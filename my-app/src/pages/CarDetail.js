...
const InformationPage = () => {
    ...
    useEffect(() => {
        const fetchCarInfo = async () => {
            try {
                const license = window.location.pathname.split('/').pop(); // Extract license from URL
                ...
                // Set carInfo to the first item in the car_detail array
        ...
        <div>
            ...
            <div className="container mx-auto py-8">
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    ...
                    <img className=" rounded-lg scale-100" style={{ marginRight: '10%', marginLeft: '10%', width: '30%' }} src="https://car-images.bauersecure.com/wp-images/3695/maserati-mc20-lead.jpg" alt="Car" />
                </div>
                ...
                <div className="container mx-auto mt-10 ml-40 ">
                    <div className="w-1/6 flex text-left">
                        ...
                        <div className="w-3/6  ml-40  text-left">
                            ...
                            <p className='text-2xl mb-7'>{`${carInfo.engine_capacity}`}</p>
                        </div>
